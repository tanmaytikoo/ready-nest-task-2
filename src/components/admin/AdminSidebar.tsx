...
const routes = [
  { label: "Dashboard", icon: LayoutDashboard, href: "/admin/dashboard", color: "text-neutral-400" },
  { label: "Departments", icon: Layers, href: "/admin/departments", color: "text-neutral-400" },
  { label: "Subjects", icon: BookOpen, href: "/admin/subjects", color: "text-neutral-400" },
  { label: "Users Directory", icon: Users, href: "/admin/users", color: "text-neutral-400" },
];
...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      <Link href="/admin/dashboard" className="h-16 flex items-center gap-3 px-6 border-b border-white/10 active:scale-95 transition-transform hover:opacity-80">
